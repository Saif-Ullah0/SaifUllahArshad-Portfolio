...
function StickyCard({
  ...
  // Dynamic sticky top offset based on device size
  const stickyTop = isMobile ? 60 + index * 12 : 80 + index * 8;
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {project.stack.slice(0, isMobile ? 4 : 5).map((tech) => (
                  <span
                    key={tech}
                    style={{
                      fontFamily: "var(--font-mono)",
                ...
                {project.github && (
                  <a
                    ...
                    style={{
                      ...
                      color: "var(--color-text-secondary)",
                      textDecoration: "none",
                      padding: isMobile ? "0.4rem 0.85rem" : "0.5rem 1.25rem",
                      borderRadius: "8px",
                      border: "1px solid var(--color-border)",
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      style={{
        padding: isMobile ? "4rem 1rem 6rem" : "6rem 1.5rem",
        position: "relative",
      }}
    >
